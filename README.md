...
```
npm create cloudflare@latest -- --template=cloudflare/templates/empty-butterfly-b8da
```

## Preview Deployment

A live public deployment of this template is available at [https://empty-butterfly-b8da.templates.workers.dev](https://empty-butterfly-b8da.templates.workers.dev)
